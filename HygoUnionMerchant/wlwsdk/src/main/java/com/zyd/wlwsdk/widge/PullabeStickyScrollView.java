 ...
 * scrollview滑动标题栏变色
 */
public class PullabeStickyScrollView extends PullableScrollView {
    ...
    public PullabeStickyScrollView(Context context) {
        this(context, null);
    }

    public PullabeStickyScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.scrollViewStyle);
    }

    public PullabeStickyScrollView(Context context, AttributeSet attrs, int defStyle) {
