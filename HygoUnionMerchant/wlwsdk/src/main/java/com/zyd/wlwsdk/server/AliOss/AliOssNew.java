 ...
 * okhttp-2.6.0
 * okio-1.6.0
 * Created by Dlt on 2017/10/9 11:35
 */
public abstract class AliOssNew {
...
//    public static final String endpoint = "http://oss.glo-iot.com";// OSS 对外服务的访问域名
...
//    public static final String BucketName = "qqwlw";//这里一定不能改，否则报错--SignatureDoesNotMatch
//    //class首的aliyunBucketName更改
//    public static final String aliyunPath1 = "http://qqwlw.oss-cn-shenzhen.aliyuncs.com/";

    //20180111更改配置
    public static final String endpoint = "oss-cn-shenzhen.aliyuncs.com";// OSS 对外服务的访问域名
    ...
    public static final String BucketName = "tj-hygo-shop";//这里一定不能改，否则报错--SignatureDoesNotMatch
    //class首的aliyunBucketName更改
    public static final String aliyunPath1 = "http://oss.zhenxuanzhuangyuan.com/";

//    public AliOssNew(Context mContext, String picName, byte[] picurlpath) {
//        this.mContext = mContext;
//        this.picName = picName;
//        this.picurlpath = picurlpath;
//    }

    public AliOssNew(Context mContext, String picName, String picurlpath) {
        this.mContext = mContext;
        this.picName = picName;
        this.picurlpath = picurlpath;
    }
