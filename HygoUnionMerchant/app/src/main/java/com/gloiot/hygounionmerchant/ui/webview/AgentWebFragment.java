...
/**
 * Created by Dlt on 2017/8/25 11:33
 */
public class AgentWebFragment extends Fragment implements FragmentKeyDown{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(mAgentWeb!=null){
            mAgentWeb.getJsInterfaceHolder().addJavaObject("android",new AndroidInterface(mAgentWeb,this.getActivity(),this.getActivity()));
