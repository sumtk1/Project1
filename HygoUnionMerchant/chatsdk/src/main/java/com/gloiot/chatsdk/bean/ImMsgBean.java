...
public class ImMsgBean implements Serializable {
    ...
    public ImMsgBean(int id, String msgid, String sendid, String receiveid, String sessiontype, String msgtype, String message, String pushdata,
                     String sendTime, int messageState, boolean isRead, String extra) {
        this.id = id;
        this.msgid = msgid;
        this.sendid = sendid;
