...
public class SocketListener {
    ...
    public Emitter.Listener onConnect = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            SocketServer.socketOn("message", new Emitter.Listener() {
                @Override
                public void call(Object... args) {
                    L.e("chatsdk-message", "message_ack");
                    L.e("chatsdk-message", args[0] + "");
    ...
    public Emitter.Listener onConnectError = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            ...
            L.e("chatsdk-Error", "onConnectError------" + args.length + "-------" + args[0]);
    ...
    public void connectionRenZheng(final String userid, final String random) {
        ...
        try {
            ...
            L.e("chatsdk-auth-jsonObject", jsonObject.toString());
    ...
    private void auth(String authConten, final CallBackListener.AuthListener emitCall) {
        final Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    L.e("chatsdk-auth-thread", "收到ack回调结束线程");
                }
            }
        });
        thread.start();
        mSocket.emit("auth", authConten, new Ack() {
            ...
            public void call(Object... args) {
                ...
                try {
                    L.e("chatsdk-auth-Ack", "args.length----" + args.length);
                    L.e("chatsdk-auth-Ack", args[0] + "");
    ...
    public void heartbeatSocket() {
        ...
        if (task == null) {
            task = new TimerTask() {
                ...
                public void run() {
                    // 打印socket是否在连接中
                    L.e("chatsdk---task", SocketServer.connected() + ", socketid:" + SocketServer.mSocket.id());
